...
@property (nonatomic) WKWebView *mWKWebView;
...
- (void)viewDidLoad {
    [super viewDidLoad];
    _mWKWebView = [[WKWebView alloc] initWithFrame:self.view.bounds];
    [_mWKWebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"https://www.baidu.com"]]];
    [_mWKWebView setUIDelegate:self];
    [_mWKWebView setNavigationDelegate:self];
...
-(void)viewDidLayoutSubviews{
    ...
    if(_mWKWebView){
        [_mWKWebView setFrame:self.view.bounds];
    }
}
